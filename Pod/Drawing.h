...
public:
	...
	void draw(LPDIRECT3DTEXTURE9 texture, RECT _srcRect, D3DXVECTOR3 _position, D3DXVECTOR2 _translate, bool _isFlip, D3DCOLOR _color = D3DCOLOR_XRGB(255, 255, 255));
	void draw(LPDIRECT3DTEXTURE9 texture, RECT _srcRect, D3DXVECTOR3 _position, bool _isFlip, bool _isVerticalFlip, D3DXVECTOR2 _translate, D3DCOLOR _color = D3DCOLOR_XRGB(255, 255, 255));
