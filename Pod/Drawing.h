...
public:
	...
	void draw(LPDIRECT3DTEXTURE9 texture, RECT* _srcRect, D3DXVECTOR3* _center, D3DXVECTOR3* _position, D3DCOLOR _color = D3DCOLOR_XRGB(255, 255, 255), bool _isFlip = false, D3DXVECTOR2* _translation = new D3DXVECTOR2(0, 0));
